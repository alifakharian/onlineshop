            ...
            return (
              <Link to={`/product/${elem.slug}`} key={elem.id}>
                ...
                >
                  ...
                  <div className="bg-rose-600 font-bold duration-700 hover:dark:bg-blue-800 hover:bg-rose-800 dark:bg-blue-600 text-white rounded-b-lg p-1 text-[13px] text-center px-[20px] w-[180px]  mx-auto">
                    نمایش بیش تر
                  </div>
                </div>
              </Link>
